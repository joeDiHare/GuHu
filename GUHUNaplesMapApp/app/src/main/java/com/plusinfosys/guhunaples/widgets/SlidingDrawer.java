...
public class SlidingDrawer extends ViewGroup {
	...
	public SlidingDrawer(final Context context, final AttributeSet attributeSet, final int defStyle) {
		...
		animateOnClick = typedArray.getBoolean(R.styleable.SlidingDrawer_animateOnClick, false);
		allowSingleTap = typedArray.getBoolean(R.styleable.SlidingDrawer_allowSingleTap, false);
	...
	protected void onLayout(final boolean changed, final int left, final int top, final int right,
		...
		if (!isTracking) {
			...
			if (isVertical) {
				...
				//handleLeft = (width - handleMeasuredWidth) /8;
                handleLeft =left;
